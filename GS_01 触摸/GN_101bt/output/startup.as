	...
	; Compiler options:
	;
	; -oGN_101bt.cof -mGN_101bt.map --summary=default,-psect,-class \
	; --fill=0xFFFF --output=intel main.p1 \
	; D:\我的文档\Documents\WeChat Files\hmm665544\FileStorage\File\2020-07\GS_01 触摸(1)\GS_01 触摸\GN_101bt\Touch_Kscan_Library.lpp \
	; --chip=SC8F8122 -P --runtime=default, \
