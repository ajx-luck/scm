...
#define		A_LED5_OUT					 TRISA	&= 0xDF
#define		A_LED4_OUT					 TRISA	&= 0xEF
#define		A_LED3_OUT					 TRISA	&= 0xF7
#define		A_LED2_OUT					 TRISB	&= 0xEF
#define		A_LED1_OUT					 TRISB	&= 0xF7
...
void setBatStep()
{
	...
	else
	{
		...
		if(chrgFlag)
		{
			...
			{
				if(++count30s >= 10000 && showBatStep < 100)	//20s
				{	
					count30s = 0;
					showBatStep++;
				}
...
void Sleep_Mode()
{
	...
	IOCB = 0B00100100;			//允许RB5的IO口电平变化中断
