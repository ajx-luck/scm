...
;; *************** function _main *****************
;; Defined at:
;;		line 124 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
...
psect	maintext,global,class=CODE,delta=2,split=1,group=0
	file	"C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
	line	124
global __pmaintext
...
l663:	
	line	131
# 131 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
clrwdt ;# 
psect	maintext
	line	132
...
;; *************** function _workCtr *****************
;; Defined at:
;;		line 539 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _pwmStop *****************
;; Defined at:
;;		line 925 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _pwmInit *****************
;; Defined at:
;;		line 910 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _ledCtr *****************
;; Defined at:
;;		line 231 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _keyCtr *****************
;; Defined at:
;;		line 497 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
;; *************** function _keyRead *****************
;; Defined at:
;;		line 464 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _chrgCtr *****************
;; Defined at:
;;		line 299 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3213:	
;main.c: 301: if(PORTA & 0x10)
	bsf	status, 5	;RP0=1, select bank1
	btfss	(134)^080h,(4)&7	;volatile
	goto	u3491
	goto	u3490
u3491:
	goto	l3347
...
l3285:	
;main.c: 371: }
;main.c: 372: if(chrgMode == 2 && outADValue < 10)
		movlw	2
	xorwf	((_chrgMode)),w
	btfss	status,2
	goto	u3621
...
;; Defined at:
;;		line 904 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 887 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _checkOutA *****************
;; Defined at:
;;		line 580 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l3117:	
;main.c: 585: {
;main.c: 586: if(chrgFlag && adresult > 210)
	movf	((_chrgFlag)),w
	btfsc	status,2
	goto	u3261
	goto	u3260
...
l3123:	
;main.c: 589: {
;main.c: 590: overChrgTime = 0;
	clrf	(_overChrgTime)
	line	591
	
l3125:	
;main.c: 591: protectFlag = 2;
	movlw	low(02h)
	movwf	(_protectFlag)
	goto	l3129
	line	597
...
;main.c: 595: else
;main.c: 596: {
;main.c: 597: overChrgTime = 0;
	clrf	(_overChrgTime)
	line	599
	
l3129:	
;main.c: 598: }
;main.c: 599: outADValue = adresult;
...
l3131:	
;main.c: 601: if(workStep && (outADValue > 220))
	movf	((_workStep)),w
	btfsc	status,2
	goto	u3291
	goto	u3290
...
l3135:	
;main.c: 602: {
;main.c: 603: if(++workOverOutTime > 50)
	movlw	low(033h)
...
l3137:	
;main.c: 604: {
;main.c: 605: workOverOutTime = 0;
	clrf	(_workOverOutTime)
	line	606
;main.c: 606: workStep = 0;
	clrf	(_workStep)
	goto	l3141
	line	611
...
l3143:	
;main.c: 614: if(workStep < 6 && outADValue > maxtempV)
	movlw	low(06h)
	subwf	(_workStep),w
	skipnc
	goto	u3321
...
l3151:	
;main.c: 621: else if(outADValue > (maxtempV+3))
	movlw	0
	subwf	(_outADValue+1),w
	movlw	02Ch
	skipnz
...
;main.c: 628: else
;main.c: 629: {
;main.c: 630: unsigned char maxAout = 11;
	movlw	low(0Bh)
	movwf	(checkOutA@maxAout)
	line	631
	
l3159:	
;main.c: 631: if(workStep == 1)
		decf	((_workStep)),w
	btfss	status,2
	goto	u3371
	goto	u3370
...
l3183:	
;main.c: 656: {
;main.c: 657: overCount--;
	decf	(_overCount),f
	line	659
	
l3185:	
;main.c: 658: }
;main.c: 659: if(outADValue > maxAout)
...
l3193:	
;main.c: 665: {
;main.c: 666: tempDuty = 72 + (workStep*4);
	movf	(_workStep),w
	movwf	(??_checkOutA+0)+0
	movlw	(02h)-1
u3475:
...
;; Defined at:
;;		line 708 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3409:	
;main.c: 756: }
;main.c: 757: test_adc = ADC_Sample(1, 5);
	movlw	low(05h)
	movwf	(ADC_Sample@adldo)
	movlw	low(01h)
	fcall	_ADC_Sample
...
;; Defined at:
;;		line 1015 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
...
u3065:
	...
	line	1039
# 1039 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
	line	1040
# 1040 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
	line	1041
# 1041 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
	line	1042
# 1042 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
psect	text15
	line	1043
...
;; Defined at:
;;		line 939 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;main.c: 974: RBIF = 0;
	...
	line	975
# 975 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
clrwdt ;# 
	line	977
# 977 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
sleep ;# 
	line	979
# 979 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
	line	980
# 980 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
clrwdt ;# 
	line	981
# 981 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
	line	982
# 982 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
	line	983
# 983 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
	line	984
# 984 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
	line	985
# 985 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
psect	text16
	line	986
...
;; Defined at:
;;		line 795 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2139:	
# 797 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
nop ;# 
	line	798
# 798 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
clrwdt ;# 
psect	text17
	line	799
...
;main.c: 799: OPTION_REG = 0;
	...
	clrf	(1)	;volatile
	line	800
# 800 "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
clrwdt ;# 
psect	text17
	line	801
...
;; *************** function _AD_Init *****************
;; Defined at:
;;		line 832 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _Isr_Timer *****************
;; Defined at:
;;		line 100 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _ledShow *****************
;; Defined at:
;;		line 163 in file "C:\mcuproject\scm\zdt\QX115_062B_SOP14\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
i1l2387:	
;main.c: 180: {
;main.c: 181: TRISB &= 0xCF;
	movlw	low(0CFh)
	andwf	(5),f	;volatile
	line	182
	
i1l2389:	
;main.c: 182: PORTB |= 0x20;
...
i1l2393:	
;main.c: 187: {
;main.c: 188: TRISB &= 0xE7;
	movlw	low(0E7h)
	andwf	(5),f	;volatile
	line	189
	
i1l2395:	
;main.c: 189: PORTB |= 0x10;
