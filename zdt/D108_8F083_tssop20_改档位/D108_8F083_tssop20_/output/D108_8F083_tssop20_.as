...
__pidataBANK0:
	file	"C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
	line	45
...
psect	strings
	file	"C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\Touch_Kscan_Library.h"
	line	77
_Table_KeyDown:
	retlw	0Ah
	retlw	0Ah
...
;; *************** function _main *****************
;; Defined at:
;;		line 828 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
...
;main.c: 837: B_MainLoop = 0;
	...
	line	838
# 838 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
clrwdt ;# 
psect	maintext
	line	840
...
l4763:	
;main.c: 845: if(firstTime == 0 && chrgFlag == 0 && workStep == 0 && wuhuaFlag == 0 && keyCount == 0 && bujinFlag == 0 && shanshuoTime == 0 && shanshuoTime2 == 0)
	bsf	status, 5	;RP0=1, select bank1
...
;; *************** function _workCtr *****************
;; Defined at:
;;		line 771 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
;; *************** function _wuhuaCtr *****************
;; Defined at:
;;		line 597 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _pwmStop *****************
;; Defined at:
;;		line 512 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l4109:	
;main.c: 515: PWMCON0 &= 0xF7;
	bcf	status, 5	;RP0=0, select bank0
	bcf	(21)+(3/8),(3)&7	;volatile
	line	516
	
l4111:	
;main.c: 516: PORTA &= 0xF7;
	bsf	status, 5	;RP0=1, select bank1
...
;; *************** function _pwmInit *****************
;; Defined at:
;;		line 500 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l4101:	
;main.c: 505: PWMD23H = 0x00;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(158)^080h	;volatile
	line	506
;main.c: 506: PWMD3L = 32;
	movlw	low(020h)
	movwf	(156)^080h	;volatile
	line	507
;main.c: 507: PWMCON1 = 0xC0;
	movlw	low(0C0h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(22)	;volatile
	line	508
...
l4103:	
;main.c: 508: PWMCON2 = 0x00;
	clrf	(29)	;volatile
	line	509
	
l4105:	
;main.c: 509: PWMCON0 |= 0x28;
	movlw	low(028h)
	iorwf	(21),f	;volatile
	line	510
...
;; *************** function _keyLedCtr *****************
;; Defined at:
;;		line 423 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l4277:	
;main.c: 428: if((shanshuoTime % 150) < 75)
	movlw	096h
...
l4289:	
;main.c: 449: if((shanshuoTime2 % 150) < 75)
	movlw	096h
	movwf	(___lwmod@divisor)
	clrf	(___lwmod@divisor+1)
...
l4293:	
;main.c: 458: else if(wuhuaFlag > 0)
	movf	((_wuhuaFlag)),w
	btfsc	status,2
	goto	u4111
	goto	u4110
...
l4301:	
;main.c: 469: if((shanshuoTime3 % 150) < 75)
	movlw	096h
	movwf	(___lwmod@divisor)
	clrf	(___lwmod@divisor+1)
...
l4311:	
;main.c: 483: {
;main.c: 484: if(chrgFullFlag || count1s < 50)
...
;; *************** function _fanCtr *****************
;; Defined at:
;;		line 537 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l4317:	
;main.c: 540: {
;main.c: 541: PORTA |= 0x02;
	bsf	(134)^080h+(1/8),(1)&7	;volatile
	line	542
	
l4319:	
;main.c: 542: unsigned char maxFanValue = 52;
	movlw	low(034h)
	bcf	status, 5	;RP0=0, select bank0
...
;; *************** function _fanStop *****************
;; Defined at:
;;		line 530 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l4127:	
;main.c: 533: PWMCON0 &= 0xEF;
	bcf	(21)+(4/8),(4)&7	;volatile
	line	534
	
l4129:	
;main.c: 534: PORTA &= 0xEF;
	bsf	status, 5	;RP0=1, select bank1
...
;; *************** function _fanInit *****************
;; Defined at:
;;		line 519 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l4113:	
;main.c: 522: PWMTH = 0x00;
	clrf	(24)	;volatile
	line	523
	
l4115:	
;main.c: 523: PWMT4L = 73;
	movlw	low(049h)
	movwf	(28)	;volatile
	line	524
	
l4117:	
;main.c: 524: PWMD4L = fanDuty;
	movf	(_fanDuty),w
	movwf	(27)	;volatile
	line	525
	
l4119:	
;main.c: 525: PWMCON1 = 0xC0;
	movlw	low(0C0h)
	movwf	(22)	;volatile
	line	526
	
l4121:	
;main.c: 526: PWMCON2 = 0x00;
	clrf	(29)	;volatile
	line	527
	
l4123:	
;main.c: 527: PWMCON0 |= 0x30;
	movlw	low(030h)
	iorwf	(21),f	;volatile
	line	528
...
;; Defined at:
;;		line 324 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
...
l4025:	
;main.c: 326: volatile unsigned long adsum = 0;
...
l4027:	
;main.c: 327: volatile unsigned int admin = 0, admax = 0;
	clrf	(ADC_Sample@admin)	;volatile
	clrf	(ADC_Sample@admin+1)	;volatile
	clrf	(ADC_Sample@admax)	;volatile
	clrf	(ADC_Sample@admax+1)	;volatile
	line	328
;main.c: 328: volatile unsigned int ad_temp = 0;
	clrf	(ADC_Sample@ad_temp)	;volatile
	clrf	(ADC_Sample@ad_temp+1)	;volatile
	line	330
	
l4029:	
;main.c: 330: if ((!LDO_EN) && (adldo & 0x04) )
	bsf	status, 5	;RP0=1, select bank1
...
l4033:	
;main.c: 331: {
;main.c: 333: ADCON1 = adldo;
	movf	(ADC_Sample@adldo),w
	movwf	(150)^080h	;volatile
	line	334
;main.c: 334: _delay((unsigned long)((100)*(8000000/4000000.0)));
	opt asmopt_push
opt asmopt_off
	movlw	66
...
l4035:	
;main.c: 336: else
;main.c: 337: ADCON1 = adldo;
	movf	(ADC_Sample@adldo),w
	movwf	(150)^080h	;volatile
	line	339
	
l4037:	
;main.c: 339: if(adch & 0x10)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l4045:	
;main.c: 345: for (i = 0; i < 10; i++)
	clrf	(ADC_Sample@i)
	line	347
	
l4051:	
;main.c: 346: {
;main.c: 347: ADCON0 = (unsigned char)(0X41 | (adch << 2));
...
u3705:
	...
	line	348
# 348 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
nop ;# 
	line	349
# 349 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
nop ;# 
	line	350
# 350 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
nop ;# 
	line	351
# 351 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
nop ;# 
psect	text11
	line	352
...
l4055:	
;main.c: 354: unsigned char j = 0;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(ADC_Sample@j)
	line	355
;main.c: 355: while (GODONE)
	goto	l993
	
l994:	
	line	357
;main.c: 356: {
;main.c: 357: _delay((unsigned long)((2)*(8000000/4000000.0)));
		opt asmopt_push
	opt asmopt_off
	nop2	;2 cycle nop
	nop2	;2 cycle nop
...
l4061:	
;main.c: 361: }
;main.c: 363: ad_temp = (unsigned int)((ADRESH << 4) + (ADRESL >> 4));
...
l4067:	
;main.c: 366: {
;main.c: 367: admax = ad_temp;
	movf	(ADC_Sample@ad_temp+1),w	;volatile
	movwf	(ADC_Sample@admax+1)	;volatile
	movf	(ADC_Sample@ad_temp),w	;volatile
	movwf	(ADC_Sample@admax)	;volatile
	line	368
;main.c: 368: admin = ad_temp;
	movf	(ADC_Sample@ad_temp+1),w	;volatile
...
l4069:	
;main.c: 370: else if (ad_temp > admax)
	movf	(ADC_Sample@ad_temp+1),w	;volatile
...
l4073:	
;main.c: 372: else if (ad_temp < admin)
...
;; *************** function _bujinCtr *****************
;; Defined at:
;;		line 656 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
;; *************** function _chrgCtr *****************
;; Defined at:
;;		line 393 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3837:	
;main.c: 396: {
;main.c: 397: chrgFlag = 1;
	clrf	(_chrgFlag)
	incf	(_chrgFlag),f
	line	398
	
l3839:	
;main.c: 398: firstLock = 0;
	clrf	(_firstLock)
	line	399
;main.c: 399: lowBatLock = 0;
	clrf	(_lowBatLock)
	line	400
	
l3841:	
;main.c: 400: if(power_ad > 4140)
	movlw	010h
	subwf	(_power_ad+1),w	;volatile
	movlw	02Dh
	skipnz
...
l3843:	
;main.c: 401: {
;main.c: 402: if(++chrgFullTime > 200)
	movlw	low(0C9h)
...
l3845:	
;main.c: 403: {
;main.c: 404: chrgFullTime = 0;
	clrf	(_chrgFullTime)
	line	405
	
l3847:	
;main.c: 405: chrgFullFlag = 1;
	clrf	(_chrgFullFlag)
...
;main.c: 414: else
;main.c: 415: {
;main.c: 416: chrgFlag = 0;
	clrf	(_chrgFlag)
	line	417
;main.c: 417: chrgFullTime = 0;
	clrf	(_chrgFullTime)
	line	418
;main.c: 418: chrgFullFlag = 0;
	clrf	(_chrgFullFlag)
	line	421
...
;; *************** function _WorkSleep *****************
;; Defined at:
;;		line 245 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l4621:	
;main.c: 248: static unsigned char time;
;main.c: 250: if(B_OnOff)time = 0;
...
l4629:	
;main.c: 267: PORTA = 0x01;
	movlw	low(01h)
	movwf	(134)^080h	;volatile
	line	268
	
l4631:	
;main.c: 268: PORTB = 0x00;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(6)	;volatile
	line	269
...
l4657:	
;main.c: 297: PORTB &= 0xFD;
	bcf	(6)+(1/8),(1)&7	;volatile
	line	298
	
l4659:	
;main.c: 298: ADCON0 = 0X41;
	movlw	low(041h)
	bsf	status, 5	;RP0=1, select bank1
	movwf	(149)^080h	;volatile
	line	299
...
clrwdt ;# 
psect	text19
	file	"C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\TouchKeyConst.h"
	line	5
...
;; Defined at:
;;		line 100 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _KeyServer *****************
;; Defined at:
;;		line 114 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3731:	
;main.c: 123: if ((KeyOldFlag & 0x1) && (KeyFlag[0] & 0x1) && firstLock == 0 )
...
;main.c: 142: }
;main.c: 143: }
;main.c: 144: if ((KeyOldFlag & 0x2) && (KeyFlag[0] & 0x2) && firstLock == 0)
...
;main.c: 163: }
;main.c: 165: }
;main.c: 166: if ((KeyOldFlag & 0x4) && (KeyFlag[0] & 0x4) && firstLock == 0 && workStep > 0 )
...
l3789:	
;main.c: 214: longKeyFlag = 0;
	clrf	(KeyServer@KeyOldFlag)
	line	215
;main.c: 215: keyCount = 0;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(_keyCount)^080h
...
;; Defined at:
;;		line 63 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3699:	
# 65 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
nop ;# 
	line	66
# 66 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
clrwdt ;# 
psect	text22
	line	67
...
;; *************** function _Isr_Timer *****************
;; Defined at:
;;		line 223 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
