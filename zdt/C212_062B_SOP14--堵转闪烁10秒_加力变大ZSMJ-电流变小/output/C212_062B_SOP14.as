...
;; *************** function _main *****************
;; Defined at:
;;		line 124 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
...
psect	maintext,global,class=CODE,delta=2,split=1,group=0
	file	"C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
	line	124
global __pmaintext
...
l661:	
	line	131
# 131 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
clrwdt ;# 
psect	maintext
	line	132
...
;; *************** function _workCtr *****************
;; Defined at:
;;		line 550 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2801:	
;main.c: 554: {
;main.c: 555: startTime--;
	decf	(_startTime),f
	line	557
	
l2803:	
;main.c: 556: }
;main.c: 557: if(workStep > 0)
	movf	((_workStep)),w
	btfsc	status,2
	goto	u2721
	goto	u2720
...
l2809:	
;main.c: 562: }
;main.c: 563: maxDuty = 43 + (workStep*2);
	clrc
	rlf	(_workStep),w
	addlw	02Bh
	movwf	(_maxDuty)
...
l2815:	
;main.c: 567: {
;main.c: 568: count5s = 0;
	clrf	(_count5s)
	clrf	(_count5s+1)
	line	569
	
l2817:	
;main.c: 569: overWorkTime = 1000;
	movlw	0E8h
	movwf	(_overWorkTime)
	movlw	03h
...
l2819:	
;main.c: 570: preLedStep = workStep;
	movf	(_workStep),w
	movwf	(_preLedStep)
	line	571
...
l2823:	
;main.c: 578: }
;main.c: 579: if(count1s == 0 && ++count900s >= 900)
	movf	((_count1s)),w
	btfss	status,2
	goto	u2761
	goto	u2760
...
;; *************** function _pwmStop *****************
;; Defined at:
;;		line 936 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _pwmInit *****************
;; Defined at:
;;		line 921 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2225:	
;main.c: 923: PWMCON1 = 0B00000000;
	clrf	(22)	;volatile
	line	924
;main.c: 924: PWMTH = 0X00;
	clrf	(24)	;volatile
	line	925
	
l2227:	
;main.c: 925: PWMTL = 100;
	movlw	low(064h)
	movwf	(23)	;volatile
	line	928
	
l2229:	
;main.c: 928: PWMD01H = 0;
	clrf	(30)	;volatile
	line	929
;main.c: 929: PWMD1L = 50;
	movlw	low(032h)
	movwf	(26)	;volatile
	line	930
	
l2231:	
;main.c: 930: PWM01DT = 0X00;
	clrf	(31)	;volatile
	line	932
	
l2233:	
;main.c: 932: PWMCON0 = 0X62;
	movlw	low(062h)
	movwf	(21)	;volatile
	line	933
;main.c: 933: PWMCON2 =0X00;
	clrf	(29)	;volatile
	line	934
...
;; *************** function _ledCtr *****************
;; Defined at:
;;		line 231 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _keyCtr *****************
;; Defined at:
;;		line 508 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l2765:	
;main.c: 510: char kclick = keyRead(0x04 & (~PORTB));
	comf	(6),w	;volatile
	andlw	04h
	fcall	_keyRead
	movwf	(keyCtr@kclick)
...
l2775:	
;main.c: 520: else if(overWorkTime > 0)
	movf	((_overWorkTime)),w
iorwf	((_overWorkTime+1)),w
	btfsc	status,2
	goto	u2671
...
l2777:	
;main.c: 521: {
;main.c: 522: overWorkTime = 0;
	clrf	(_overWorkTime)
	clrf	(_overWorkTime+1)
	line	523
	
l2779:	
;main.c: 523: workStep = preLedStep;
	movf	(_preLedStep),w
	movwf	(_workStep)
	line	524
;main.c: 524: }
...
l2781:	
;main.c: 525: else if(showBatTime > 0)
	movf	((_showBatTime)),w
	btfsc	status,2
	goto	u2681
	goto	u2680
...
;main.c: 529: else
;main.c: 530: {
;main.c: 531: showBatTime = 200;
	movlw	low(0C8h)
	movwf	(_showBatTime)
	line	532
	
l2787:	
;main.c: 532: count1s = 0;
	clrf	(_count1s)
	goto	l784
	line	535
	
l2789:	
;main.c: 535: else if(kclick == 2)
		movlw	2
...
;main.c: 541: else
;main.c: 542: {
;main.c: 543: workStep = 1;
	clrf	(_workStep)
	incf	(_workStep),f
	line	544
	
l2795:	
;main.c: 544: startTime = 30;
	movlw	low(01Eh)
	movwf	(_startTime)
	goto	l2783
	line	548
...
;; *************** function _keyRead *****************
;; Defined at:
;;		line 475 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
...
l2191:	
;main.c: 481: {
;main.c: 482: keyCount = 100;
	movlw	low(064h)
	movwf	(_keyCount)
	line	483
	
l2193:	
;main.c: 483: if(!longPressFlag)
...
;; *************** function _chrgCtr *****************
;; Defined at:
;;		line 299 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3297:	
;main.c: 361: else if(batADValue < 1400)
	movlw	05h
	subwf	(_batADValue+1),w
	movlw	078h
	skipnz
...
l3305:	
;main.c: 367: else if(batADValue < 1530)
	movlw	05h
	subwf	(_batADValue+1),w
	movlw	0FAh
	skipnz
...
l3307:	
;main.c: 368: {
;main.c: 369: chrgMode = 1;
	clrf	(_chrgMode)
	incf	(_chrgMode),f
	line	370
	
l3309:	
;main.c: 370: chrgMaxAD = 30;
	movlw	low(01Eh)
	movwf	(_chrgMaxAD)
	goto	l3303
	line	373
...
l3317:	
;main.c: 376: {
;main.c: 377: lockCount = 0;
	clrf	(_lockCount)
	line	378
	
l3319:	
;main.c: 378: chrgMode = 2;
	movlw	low(02h)
	movwf	(_chrgMode)
	line	381
...
l3323:	
;main.c: 382: }
;main.c: 383: if(chrgMode == 2 && outADValue < 10)
		movlw	2
	xorwf	((_chrgMode)),w
	btfss	status,2
	goto	u3681
...
l3337:	
;main.c: 396: {
;main.c: 397: lockLedStep = 6;
	movlw	low(06h)
	movwf	(_lockLedStep)
	line	398
	
l3339:	
;main.c: 398: chrgPwmStop();
	fcall	_chrgPwmStop
	line	399
;main.c: 399: }
	goto	l728
...
;main.c: 406: else
;main.c: 407: {
;main.c: 408: lockLedStep = (prePwStep/14) - 1;
	movlw	low(0Eh)
	movwf	(___lbdiv@divisor)
	movf	(_prePwStep),w
	fcall	___lbdiv
...
l3347:	
;main.c: 409: }
;main.c: 410: if(batADValue > 1545 || outADValue > (chrgMaxAD + 2))
	movlw	06h
	subwf	(_batADValue+1),w
	movlw	0Ah
	skipnz
...
l3351:	
;main.c: 411: {
;main.c: 412: if(++subTime > chrgWaitTime)
	incf	(_subTime),f
	movf	((_subTime)),w
...
l3355:	
;main.c: 415: {
;main.c: 416: chrgMaxDuty--;
	decf	(_chrgMaxDuty),f
	line	418
	
l3357:	
;main.c: 417: }
;main.c: 418: subTime = 0;
	clrf	(_subTime)
	line	419
	
l3359:	
;main.c: 419: chrgWaitTime = 50;
	movlw	low(032h)
	movwf	(_chrgWaitTime)
	line	421
...
l3363:	
;main.c: 423: else if(batADValue < 1545 && outADValue < (chrgMaxAD - 4))
	movlw	06h
	subwf	(_batADValue+1),w
	movlw	09h
	skipnz
...
l3367:	
;main.c: 424: {
;main.c: 425: if(++addTime > chrgWaitTime)
	incf	(_addTime),f
	movf	((_addTime)),w
	subwf	(_chrgWaitTime),w
	skipnc
...
l3369:	
;main.c: 426: {
;main.c: 427: addTime = 0;
	clrf	(_addTime)
	line	428
	
l3371:	
;main.c: 428: if(chrgMaxDuty < 75)
	movlw	low(04Bh)
	subwf	(_chrgMaxDuty),w
	skipnc
	goto	u3801
...
;main.c: 431: }
;main.c: 432: }
;main.c: 433: subTime = 0;
	clrf	(_subTime)
	line	437
	
l3377:	
;main.c: 434: }
;main.c: 437: if((PWMCON0 & 0x01) == 0)
...
;main.c: 450: protectFlag = 0;
	clrf	(_protectFlag)
	line	451
;main.c: 451: chrgMode = 0;
	clrf	(_chrgMode)
	line	452
;main.c: 452: chrgMaxAD = 0;
	clrf	(_chrgMaxAD)
	line	453
;main.c: 453: chrgMaxDuty = 0;
	clrf	(_chrgMaxDuty)
	line	454
;main.c: 454: lockCount = 0;
	clrf	(_lockCount)
	line	455
;main.c: 455: lockLedStep = 0;
	clrf	(_lockLedStep)
	line	456
	
l3387:	
;main.c: 456: chrgWaitTime = 20;
	movlw	low(014h)
	movwf	(_chrgWaitTime)
	line	457
	
l3389:	
;main.c: 457: chrgPwmStop();
	fcall	_chrgPwmStop
	line	458
	
l3391:	
;main.c: 458: if(prePwStep > 0 && prePwStep > pwStep)
	movf	((_prePwStep)),w
	btfsc	status,2
	goto	u3821
	goto	u3820
...
;; Defined at:
;;		line 915 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 898 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2175:	
;main.c: 900: PWMCON1 = 0B00000000;
	clrf	(22)	;volatile
	line	902
;main.c: 902: PWMTH = 0X00;
	clrf	(24)	;volatile
	line	903
	
l2177:	
;main.c: 903: PWMTL = 100;
	movlw	low(064h)
	movwf	(23)	;volatile
	line	907
	
l2179:	
;main.c: 907: PWMD01H = 0;
	clrf	(30)	;volatile
	line	908
;main.c: 908: PWMD0L = 1;
	movlw	low(01h)
...
l2181:	
;main.c: 909: PWM01DT = 0X00;
	clrf	(31)	;volatile
	line	911
	
l2183:	
;main.c: 911: PWMCON0 = 0X01;
	movlw	low(01h)
	movwf	(21)	;volatile
	line	912
;main.c: 912: PWMCON2 =0X00;
	clrf	(29)	;volatile
	line	913
...
;; *************** function _checkOutA *****************
;; Defined at:
;;		line 591 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l3135:	
;main.c: 594: {
;main.c: 595: test_adc = ADC_Sample(4, 5);
	movlw	low(05h)
...
;main.c: 597: else
;main.c: 598: {
;main.c: 599: test_adc = ADC_Sample(0, 5);
	movlw	low(05h)
	movwf	(ADC_Sample@adldo)
	movlw	low(0)
	fcall	_ADC_Sample
...
l3141:	
;main.c: 602: {
;main.c: 603: if(chrgFlag && adresult > 210)
	movf	((_chrgFlag)),w
	btfsc	status,2
	goto	u3311
	goto	u3310
...
l3147:	
;main.c: 606: {
;main.c: 607: overChrgTime = 0;
	clrf	(_overChrgTime)
	line	608
	
l3149:	
;main.c: 608: protectFlag = 2;
	movlw	low(02h)
	movwf	(_protectFlag)
	goto	l3153
	line	614
...
;main.c: 612: else
;main.c: 613: {
;main.c: 614: overChrgTime = 0;
	clrf	(_overChrgTime)
	line	616
	
l3153:	
;main.c: 615: }
;main.c: 616: outADValue = adresult;
...
l3155:	
;main.c: 618: if(workStep && (outADValue > 220))
	movf	((_workStep)),w
	btfsc	status,2
	goto	u3341
	goto	u3340
...
l3159:	
;main.c: 619: {
;main.c: 620: if(++workOverOutTime > 50)
	movlw	low(033h)
...
l3161:	
;main.c: 621: {
;main.c: 622: workOverOutTime = 0;
	clrf	(_workOverOutTime)
	line	623
;main.c: 623: workStep = 0;
	clrf	(_workStep)
	goto	l3165
	line	628
...
l3167:	
;main.c: 631: if(workStep < 6 && outADValue > maxtempV)
	movlw	low(06h)
	subwf	(_workStep),w
	skipnc
	goto	u3371
...
l3175:	
;main.c: 638: else if(outADValue > (maxtempV+3))
	movlw	0
	subwf	(_outADValue+1),w
	movlw	02Ch
	skipnz
...
;main.c: 645: else
;main.c: 646: {
;main.c: 647: unsigned char maxAout = 11;
	movlw	low(0Bh)
	movwf	(checkOutA@maxAout)
	line	648
	
l3183:	
;main.c: 648: if(workStep == 1)
		decf	((_workStep)),w
	btfss	status,2
	goto	u3421
	goto	u3420
...
l3207:	
;main.c: 673: {
;main.c: 674: overCount--;
	decf	(_overCount),f
	line	676
	
l3209:	
;main.c: 675: }
;main.c: 676: if(outADValue > maxAout)
...
l3213:	
;main.c: 679: {
;main.c: 680: addPowerCount = 3;
	movlw	low(03h)
	movwf	(_addPowerCount)
	line	681
	
l3215:	
;main.c: 681: if(startTime == 0)
	movf	((_startTime)),w
	btfss	status,2
	goto	u3511
	goto	u3510
...
l3217:	
;main.c: 682: {
;main.c: 683: tempDuty = 87 + (workStep*2);
	clrc
	rlf	(_workStep),w
	addlw	057h
	movwf	(_tempDuty)
...
;main.c: 693: else
;main.c: 694: {
;main.c: 695: addPowerCount = 0;
	clrf	(_addPowerCount)
	line	696
	
l3223:	
;main.c: 696: if(tempDuty > maxDuty)
	movf	(_tempDuty),w
	subwf	(_maxDuty),w
	skipnc
	goto	u3521
...
;main.c: 705: }
;main.c: 707: }
;main.c: 708: PWMD01H = 0X00;
	clrf	(30)	;volatile
	line	709
	
l3231:	
;main.c: 709: PWMD1L = tempDuty;
	movf	(_tempDuty),w
	movwf	(26)	;volatile
	line	710
;main.c: 710: }
...
l3235:	
;main.c: 715: _delay((unsigned long)((100)*(16000000/4000000.0)));
	opt asmopt_push
opt asmopt_off
	movlw	133
...
;; Defined at:
;;		line 719 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3403:	
;main.c: 721: test_adc = ADC_Sample(2, 5);
	movlw	low(05h)
	movwf	(ADC_Sample@adldo)
	movlw	low(02h)
	fcall	_ADC_Sample
...
l3407:	
;main.c: 723: {
;main.c: 724: batADValue = adresult;
	movf	(_adresult+1),w	;volatile
	movwf	(_batADValue+1)
	movf	(_adresult),w	;volatile
	movwf	(_batADValue)
	line	725
;main.c: 725: if(batADValue < 1145)
	movlw	04h
	subwf	(_batADValue+1),w
	movlw	079h
	skipnz
...
l3413:	
;main.c: 729: {
;main.c: 730: count8s = 0;
	clrf	(_count8s)
	clrf	(_count8s+1)
	line	731
	
l3415:	
;main.c: 731: lowBatFlag = 1;
	clrf	(_lowBatFlag)
	incf	(_lowBatFlag),f
	line	732
	
l3417:	
;main.c: 732: if(workStep > 0)
	movf	((_workStep)),w
	btfsc	status,2
	goto	u3881
	goto	u3880
...
l3419:	
;main.c: 733: {
;main.c: 734: overWorkTime = 120;
	movlw	078h
	movwf	(_overWorkTime)
	clrf	(_overWorkTime+1)
	line	735
;main.c: 735: preLedStep = workStep;
	movf	(_workStep),w
	movwf	(_preLedStep)
	line	737
...
l3421:	
;main.c: 736: }
;main.c: 737: prePwStep = 0;
	clrf	(_prePwStep)
	line	738
	
l3423:	
;main.c: 738: workStep = 0;
	clrf	(_workStep)
	goto	l3437
	line	743
...
;main.c: 741: else
;main.c: 742: {
;main.c: 743: count8s = 0;
	clrf	(_count8s)
	clrf	(_count8s+1)
	line	744
	
l3427:	
;main.c: 744: if(batADValue >= 1340)
	movlw	05h
	subwf	(_batADValue+1),w
	movlw	03Ch
	skipnz
...
l3429:	
;main.c: 745: {
;main.c: 746: pwStep = ((batADValue - 1340) /2) + 13;
	movf	(_batADValue),w
	addlw	low(0FAC4h)
...
;main.c: 748: else
;main.c: 749: {
;main.c: 750: pwStep = (batADValue - 1117) / 16;
	movf	(_batADValue),w
	addlw	low(0FBA3h)
	movwf	(??_checkBatAD+0)+0
	movf	(_batADValue+1),w
...
;main.c: 755: }
;main.c: 756: }
;main.c: 757: if(chrgFlag && batADValue > 1861)
	movf	((_chrgFlag)),w
	btfsc	status,2
	goto	u3921
	goto	u3920
...
l3445:	
;main.c: 766: _delay((unsigned long)((100)*(16000000/4000000.0)));
	opt asmopt_push
opt asmopt_off
	movlw	133
...
l3447:	
;main.c: 767: }
;main.c: 768: test_adc = ADC_Sample(3, 5);
	movlw	low(05h)
	movwf	(ADC_Sample@adldo)
	movlw	low(03h)
	fcall	_ADC_Sample
...
l3451:	
;main.c: 770: {
;main.c: 771: if(chrgFlag && adresult > 100)
	movf	((_chrgFlag)),w
	btfsc	status,2
	goto	u3951
	goto	u3950
...
l3455:	
;main.c: 772: {
;main.c: 774: if(adresult > 810 || (batADValue - adresult) > 810)
	movlw	03h
	subwf	(_adresult+1),w	;volatile
	movlw	02Bh
	skipnz
...
l3459:	
;main.c: 775: {
;main.c: 777: if(++countHalfFull > 250)
	movlw	low(0FBh)
...
l3461:	
;main.c: 778: {
;main.c: 779: countHalfFull = 0;
	clrf	(_countHalfFull)
	line	780
	
l3463:	
;main.c: 780: protectFlag = 2;
	movlw	low(02h)
	movwf	(_protectFlag)
	goto	l854
	line	785
...
l3469:	
;main.c: 793: _delay((unsigned long)((100)*(16000000/4000000.0)));
	opt asmopt_push
opt asmopt_off
	movlw	133
movwf	((??_checkBatAD+0)+0),f
...
;; Defined at:
;;		line 1026 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
...
l3023:	
;main.c: 1028: volatile unsigned long adsum = 0;
...
l3025:	
;main.c: 1029: volatile unsigned int admin = 0, admax = 0;
	clrf	(ADC_Sample@admin)	;volatile
	clrf	(ADC_Sample@admin+1)	;volatile
	clrf	(ADC_Sample@admax)	;volatile
	clrf	(ADC_Sample@admax+1)	;volatile
	line	1030
;main.c: 1030: volatile unsigned int ad_temp = 0;
	clrf	(ADC_Sample@ad_temp)	;volatile
	clrf	(ADC_Sample@ad_temp+1)	;volatile
	line	1032
	
l3027:	
;main.c: 1032: if ((!LDO_EN) && (adldo & 0x04) )
	bsf	status, 5	;RP0=1, select bank1
...
l3031:	
;main.c: 1033: {
;main.c: 1035: ADCON1 = adldo;
	movf	(ADC_Sample@adldo),w
	movwf	(150)^080h	;volatile
	line	1036
;main.c: 1036: _delay((unsigned long)((100)*(16000000/4000000.0)));
	opt asmopt_push
opt asmopt_off
	movlw	132
	bcf	status, 5	;RP0=0, select bank0
...
l3033:	
;main.c: 1038: else
;main.c: 1039: ADCON1 = adldo;
	movf	(ADC_Sample@adldo),w
	movwf	(150)^080h	;volatile
	line	1041
	
l3035:	
;main.c: 1041: if(adch & 0x10)
	bcf	status, 5	;RP0=0, select bank0
...
l3043:	
;main.c: 1047: for (i = 0; i < 10; i++)
	clrf	(ADC_Sample@i)
	line	1049
	
l3049:	
;main.c: 1048: {
;main.c: 1049: ADCON0 = (unsigned char)(0X41 | (adch << 2));
...
u3105:
	...
	line	1050
# 1050 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
	line	1051
# 1051 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
	line	1052
# 1052 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
	line	1053
# 1053 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
psect	text15
	line	1054
	
l3051:	
;main.c: 1054: GODONE = 1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1193/8)^080h,(1193)&7	;volatile
	line	1056
	
l3053:	
;main.c: 1056: unsigned char j = 0;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(ADC_Sample@j)
	line	1057
;main.c: 1057: while (GODONE)
	goto	l886
	
l887:	
	line	1059
;main.c: 1058: {
;main.c: 1059: _delay((unsigned long)((2)*(16000000/4000000.0)));
		opt asmopt_push
	opt asmopt_off
	nop2	;2 cycle nop
	nop2	;2 cycle nop
...
l3059:	
;main.c: 1063: }
;main.c: 1065: ad_temp = (unsigned int)((ADRESH << 4) + (ADRESL >> 4));
...
l3065:	
;main.c: 1068: {
;main.c: 1069: admax = ad_temp;
	movf	(ADC_Sample@ad_temp+1),w	;volatile
	movwf	(ADC_Sample@admax+1)	;volatile
	movf	(ADC_Sample@ad_temp),w	;volatile
	movwf	(ADC_Sample@admax)	;volatile
	line	1070
;main.c: 1070: admin = ad_temp;
	movf	(ADC_Sample@ad_temp+1),w	;volatile
...
l3067:	
;main.c: 1072: else if (ad_temp > admax)
	movf	(ADC_Sample@ad_temp+1),w	;volatile
...
l3071:	
;main.c: 1074: else if (ad_temp < admin)
...
;; Defined at:
;;		line 950 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;main.c: 952: INTCON = 0;
	clrf	(11)	;volatile
	line	954
;main.c: 954: OPTION_REG = 0;
	clrf	(1)	;volatile
	line	956
	
l2887:	
;main.c: 956: TRISA = 0x1F;
	movlw	low(01Fh)
	bsf	status, 5	;RP0=1, select bank1
...
l2889:	
;main.c: 957: WPUA = 0B00000000;
	clrf	(136)^080h	;volatile
	line	958
	
l2891:	
;main.c: 958: PORTA = 0x00;
	clrf	(134)^080h	;volatile
	line	959
	
l2893:	
;main.c: 959: TRISB = 0B00000100;
	movlw	low(04h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(5)	;volatile
	line	960
;main.c: 960: PORTB = 0B00000000;
	clrf	(6)	;volatile
	line	961
	
l2895:	
;main.c: 961: WPUB = 0B00000100;
	movlw	low(04h)
	movwf	(8)	;volatile
	line	963
...
l2901:	
;main.c: 966: PWMCON0 = 0;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(21)	;volatile
	line	968
;main.c: 968: OSCCON = 0X70;
	movlw	low(070h)
	movwf	(20)	;volatile
	line	970
;main.c: 970: IOCA = 0B00000010;
	movlw	low(02h)
	bsf	status, 5	;RP0=1, select bank1
	movwf	(137)^080h	;volatile
	line	971
;main.c: 971: IOCB = 0B00000100;
	movlw	low(04h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(9)	;volatile
	line	973
...
;main.c: 985: RBIF = 0;
	...
	line	986
# 986 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
clrwdt ;# 
	line	988
# 988 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
sleep ;# 
	line	990
# 990 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
	line	991
# 991 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
clrwdt ;# 
	line	992
# 992 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
	line	993
# 993 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
	line	994
# 994 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
	line	995
# 995 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
	line	996
# 996 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
psect	text16
	line	997
	
l2925:	
;main.c: 997: if(RAIF) RAIF = 0;
	bcf	status, 5	;RP0=0, select bank0
...
l2933:	
;main.c: 1000: IOCA = 0B00000000;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(137)^080h	;volatile
	line	1001
;main.c: 1001: IOCB = 0B00000000;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(9)	;volatile
	line	1002
	
l2935:	
;main.c: 1002: Init_System();
	fcall	_Init_System
	line	1003
...
;; Defined at:
;;		line 806 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2151:	
# 808 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
nop ;# 
	line	809
# 809 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
clrwdt ;# 
psect	text17
	line	810
	
l2153:	
;main.c: 810: OPTION_REG = 0;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(1)	;volatile
	line	811
# 811 "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
clrwdt ;# 
psect	text17
	line	812
	
l2155:	
;main.c: 812: OSCCON = 0X72;
	movlw	low(072h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(20)	;volatile
	line	814
...
l2157:	
;main.c: 814: WPUA = 0B00000000;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(136)^080h	;volatile
	line	815
;main.c: 815: WPDA = 0x02;
	movlw	low(02h)
	movwf	(135)^080h	;volatile
	line	816
;main.c: 816: WPUB = 0B00000100;
	movlw	low(04h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(8)	;volatile
	line	818
;main.c: 818: TRISA = 0x1F;
	movlw	low(01Fh)
	bsf	status, 5	;RP0=1, select bank1
	movwf	(133)^080h	;volatile
	line	819
;main.c: 819: TRISB = 0B00000100;
	movlw	low(04h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(5)	;volatile
	line	821
...
;main.c: 828: TMR2IE = 1;
	...
	line	830
;main.c: 830: T2CON = 0B00000100;
	movlw	low(04h)
	movwf	(19)	;volatile
	line	831
;main.c: 831: INTCON = 0XC0;
	movlw	low(0C0h)
	movwf	(11)	;volatile
	line	832
...
;; *************** function _AD_Init *****************
;; Defined at:
;;		line 843 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _Isr_Timer *****************
;; Defined at:
;;		line 100 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _ledShow *****************
;; Defined at:
;;		line 163 in file "C:\mcuproject\scm\zdt\C212_062B_SOP14--堵转闪烁10秒_加力变大ZSMJ-电流变小\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
