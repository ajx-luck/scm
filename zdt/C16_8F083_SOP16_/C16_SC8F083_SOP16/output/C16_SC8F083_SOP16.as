...
l4213:	
;main.c: 562: }
;main.c: 563: if(workStep == 2 && power_ad < 3300)
		movlw	2
	xorwf	((_workStep)),w
	btfss	status,2
	goto	u4121
...
l3937:	
;main.c: 460: unsigned char maxFanValue = 48;
	movlw	low(030h)
	bcf	status, 5	;RP0=0, select bank0
...
l3939:	
;main.c: 461: if(workStep == 1 || power_ad < 3350)
		decf	((_workStep)),w
	btfsc	status,2
	goto	u3661
	goto	u3660
