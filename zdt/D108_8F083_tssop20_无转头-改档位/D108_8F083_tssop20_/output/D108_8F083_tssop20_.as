...
psect	strings
	file	"C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\Touch_Kscan_Library.h"
	line	77
_Table_KeyDown:
	retlw	0Ah
	retlw	0Ah
...
;; *************** function _main *****************
;; Defined at:
;;		line 782 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
...
psect	maintext,global,class=CODE,delta=2,split=1,group=0
	file	"C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
	line	782
global __pmaintext
...
l4675:	
;main.c: 784: Init_System();
	fcall	_Init_System
	line	785
	
l4677:	
;main.c: 785: firstLock = 1;
...
l4683:	
;main.c: 790: {
;main.c: 791: B_MainLoop = 0;
	bcf	(_B_MainLoop/8),(_B_MainLoop)&7	;volatile
	line	792
# 792 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
clrwdt ;# 
psect	maintext
	line	794
	
l4685:	
;main.c: 794: CheckTouchKey();
...
l4689:	
;main.c: 796: Refurbish_Sfr();
	fcall	_Refurbish_Sfr
	line	797
	
l4691:	
;main.c: 797: KeyServer();
	fcall	_KeyServer
	line	798
...
l4695:	
;main.c: 799: if(firstTime == 0 && chrgFlag == 0 && workStep == 0 && powerFlag == 0 && keyCount == 0 && wuhuaFlag == 0 && bujinFlag == 0 && shanshuoTime == 0 && shanshuoTime2 == 0)
	bsf	status, 5	;RP0=1, select bank1
...
;; *************** function _workCtr *****************
;; Defined at:
;;		line 726 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l4597:	
;main.c: 728: test_adc = ADC_Sample(31, 0);
...
l4601:	
;main.c: 730: {
;main.c: 731: volatile unsigned long power_temp;
;main.c: 733: power_temp = (unsigned long)(((4096UL*1.2*1000))/adresult);
	movlw	0x0
	movwf	(___ftdiv@f1)
	movlw	0x96
	movwf	(___ftdiv@f1+1)
...
l4603:	
;main.c: 734: power_ad = (unsigned int)(power_temp);
...
l4605:	
;main.c: 735: }
;main.c: 736: if(workStep >= 2 && power_ad < 3300)
	movlw	low(02h)
	subwf	(_workStep),w
	skipc
	goto	u4711
...
l4621:	
;main.c: 751: {
;main.c: 752: lowBatTime = 0;
	clrf	(_lowBatTime)^080h
	clrf	(_lowBatTime+1)^080h
	line	753
	
l4623:	
;main.c: 753: lowBatLock = 1;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(_lowBatLock)
	incf	(_lowBatLock),f
	line	754
;main.c: 754: workStep = 0;
	clrf	(_workStep)
	line	755
;main.c: 755: wuhuaFlag = 0;
	clrf	(_wuhuaFlag)
	line	756
;main.c: 756: bujinFlag = 0;
	clrf	(_bujinFlag)
	goto	l4627
	line	761
...
l4629:	
;main.c: 764: {
;main.c: 765: firstTime--;
	decf	(_firstTime)^080h,f
	line	766
	
l4631:	
;main.c: 766: PORTB = 0x00;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(6)	;volatile
	line	767
	
l4633:	
;main.c: 767: PORTA = 0x00;
	bsf	status, 5	;RP0=1, select bank1
...
;; *************** function _wuhuaCtr *****************
;; Defined at:
;;		line 575 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l4329:	
;main.c: 580: {
;main.c: 581: count10s = 0;
	clrf	(_count10s)
	line	583
	
l4331:	
;main.c: 582: }
;main.c: 583: if(workStep == 0 && wuhuaFlag == 0 && powerFlag > 0)
	movf	((_workStep)),w
	btfss	status,2
	goto	u4281
	goto	u4280
...
;main.c: 594: }
;main.c: 595: }
;main.c: 596: if(wuhuaFlag == 1 || (wuhuaFlag == 2 && count10s < 10))
		decf	((_wuhuaFlag)),w
	btfsc	status,2
	goto	u4321
	goto	u4320
...
;; *************** function _pwmStop *****************
;; Defined at:
;;		line 490 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _pwmInit *****************
;; Defined at:
;;		line 478 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _keyLedCtr *****************
;; Defined at:
;;		line 401 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _fanCtr *****************
;; Defined at:
;;		line 515 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l4287:	
;main.c: 532: }
;main.c: 534: test_adc = ADC_Sample(2, 0);
	clrf	(ADC_Sample@adldo)
	movlw	low(02h)
	fcall	_ADC_Sample
	movwf	(_test_adc)	;volatile
...
l4291:	
;main.c: 536: {
;main.c: 537: volatile unsigned long fan_temp;
;main.c: 538: if(power_ad > 0)
...
l4293:	
;main.c: 539: {
;main.c: 540: fan_temp = ((unsigned long)1UL*adresult * power_ad)/4096;
	movf	(_adresult),w	;volatile
...
l4297:	
;main.c: 541: fanValue = (unsigned int)(fan_temp);
...
l4303:	
;main.c: 547: {
;main.c: 548: fanOverTime = 0;
	clrf	(_fanOverTime)
	line	549
;main.c: 549: workStep = 0;
	clrf	(_workStep)
	line	550
	
l4305:	
;main.c: 550: shanshuoTime = 450;
	movlw	0C2h
	movwf	(_shanshuoTime)
	movlw	01h
...
;main.c: 553: else
;main.c: 554: {
;main.c: 555: fanOverTime = 0;
	clrf	(_fanOverTime)
	line	557
	
l4309:	
;main.c: 556: }
;main.c: 557: if(fanDuty < maxFanValue)
...
l4313:	
;main.c: 561: else if(fanDuty > maxFanValue)
	movf	(_fanDuty),w
...
l4321:	
;main.c: 570: fanDuty = 0;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(_fanDuty)
	line	571
	
l4323:	
;main.c: 571: PORTA &= 0xFD;
	bsf	status, 5	;RP0=1, select bank1
...
;; *************** function _fanStop *****************
;; Defined at:
;;		line 508 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _fanInit *****************
;; Defined at:
;;		line 497 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 302 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
...
u3675:
	...
	line	326
# 326 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
nop ;# 
	line	327
# 327 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
nop ;# 
	line	328
# 328 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
nop ;# 
	line	329
# 329 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
nop ;# 
psect	text11
	line	330
...
;; *************** function _bujinCtr *****************
;; Defined at:
;;		line 634 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l4353:	
;main.c: 636: if(bujinFlag || motorStep > 0)
	bcf	status, 5	;RP0=0, select bank0
	movf	((_bujinFlag)),w
	btfss	status,2
	goto	u4351
...
l4361:	
;main.c: 642: else if(bujinFlag == 2)
		movlw	2
	xorwf	((_bujinFlag)),w
	btfss	status,2
	goto	u4381
...
l4365:	
;main.c: 646: else if(bujinFlag == 3)
		movlw	3
	xorwf	((_bujinFlag)),w
	btfss	status,2
	goto	u4391
...
l4369:	
;main.c: 649: }
;main.c: 650: if(++motorStep >= (maxMotorStep*2))
...
l4373:	
;main.c: 653: }
;main.c: 654: unsigned char tempStep = motorStep % 8;
	movf	(_motorStep),w
...
l4377:	
;main.c: 655: if(motorStep < maxMotorStep)
	movf	(_maxMotorStep+1),w
	subwf	(_motorStep+1),w
	skipz
	goto	u4415
...
l1089:	
	line	661
;main.c: 661: RA5 = 1;RA6 = 0;RA7 = 0;RB7 = 0;
	bsf	status, 5	;RP0=1, select bank1
...
l1091:	
	line	664
;main.c: 664: RA5 = 1;RA6 = 1;RA7 = 0;RB7 = 0;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1077/8)^080h,(1077)&7	;volatile
...
l1092:	
	line	667
;main.c: 667: RA5 = 0;RA6 = 1;RA7 = 0;RB7 = 0;
	bsf	status, 5	;RP0=1, select bank1
...
l1093:	
	line	670
;main.c: 670: RA5 = 0;RA6 = 1;RA7 = 1;RB7 = 0;
	bsf	status, 5	;RP0=1, select bank1
	bcf	(1077/8)^080h,(1077)&7	;volatile
	bsf	(1078/8)^080h,(1078)&7	;volatile
...
l1094:	
	line	673
;main.c: 673: RA5 = 0;RA6 = 0;RA7 = 1;RB7 = 0;
	bsf	status, 5	;RP0=1, select bank1
	bcf	(1077/8)^080h,(1077)&7	;volatile
	bcf	(1078/8)^080h,(1078)&7	;volatile
	bsf	(1079/8)^080h,(1079)&7	;volatile
...
l1095:	
	line	676
;main.c: 676: RA5 = 0;RA6 = 0;RA7 = 1;RB7 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	(1077/8)^080h,(1077)&7	;volatile
	bcf	(1078/8)^080h,(1078)&7	;volatile
	bsf	(1079/8)^080h,(1079)&7	;volatile
...
l1096:	
	line	679
;main.c: 679: RA5 = 0;RA6 = 0;RA7 = 0;RB7 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	(1077/8)^080h,(1077)&7	;volatile
	bcf	(1078/8)^080h,(1078)&7	;volatile
	bcf	(1079/8)^080h,(1079)&7	;volatile
...
l1097:	
	line	682
;main.c: 682: RA5 = 1;RA6 = 0;RA7 = 0;RB7 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1077/8)^080h,(1077)&7	;volatile
	bcf	(1078/8)^080h,(1078)&7	;volatile
	bcf	(1079/8)^080h,(1079)&7	;volatile
...
;; *************** function _chrgCtr *****************
;; Defined at:
;;		line 371 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _WorkSleep *****************
;; Defined at:
;;		line 223 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
clrwdt ;# 
psect	text19
	file	"C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\TouchKeyConst.h"
	line	5
...
;; Defined at:
;;		line 97 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _KeyServer *****************
;; Defined at:
;;		line 111 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 60 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3649:	
# 62 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
nop ;# 
	line	63
# 63 "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
clrwdt ;# 
psect	text22
	line	64
...
;; *************** function _Isr_Timer *****************
;; Defined at:
;;		line 201 in file "C:\mcuproject\scm\zdt\D108_8F083_tssop20_无转头-改档位\D108_8F083_tssop20_\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
