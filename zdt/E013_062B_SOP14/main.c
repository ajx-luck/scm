...
#define		A_LED5_OUT					 TRISA	&= 0xFE
#define		A_LED4_OUT					 TRISA	&= 0xFD
#define		A_LED3_OUT					 TRISA	&= 0xFB
#define		A_LED2_OUT					 TRISA	&= 0xF7
#define		A_LED1_OUT					 TRISA	&= 0xEF
...
void checkTempAD()
{
	test_adc = ADC_Sample(5, 0);		//测试AN2口的AD值，参考电压2V
