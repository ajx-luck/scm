	...
	; Compiler options:
	;
	; -oCMS-TPWHQ-ZPGS.cof -mCMS-TPWHQ-ZPGS.map \
	; --summary=default,-psect,-class --fill=0xFFFF --output=intel delay.p1 \
	; Eeprom.p1 main.p1 iic_soft.p1 WHQ_Sender.p1 \
	; C:\mcuproject\scm\xfx\追频+干烧检水-24V2.4M(0818-A)\追频+干烧检水-24V2.4M(0904)\追频+干烧检水-24V2.4M - 副本\WHQ_TP_ZPGS_V1.2.lpp \
	; --chip=79F5135 -P --runtime=default, \
