...
;; *************** function _main *****************
;; Defined at:
;;		line 41 in file "H:\MyDownloads\说明书&测试报告\开发包\SC8F577X开发包\SC8F577X_DEMO\SC8F577X_SPI_master_Demo\main.c"
...
psect	maintext,global,class=CODE,delta=2,split=1,group=0
	file	"H:\MyDownloads\说明书&测试报告\开发包\SC8F577X开发包\SC8F577X_DEMO\SC8F577X_SPI_master_Demo\main.c"
	line	41
global __pmaintext
...
l1317:	
;main.c: 43: Init_System();
	fcall	_Init_System
	line	46
	
l1319:	
;main.c: 46: SPICON = 0B00100010;
	movlw	low(022h)
...
l1329:	
;main.c: 55: {
;main.c: 56: DelayXms(200);
	movlw	low(0C8h)
	fcall	_DelayXms
	line	57
	
l1331:	
;main.c: 57: SPIBUF = 0x21;
	movlw	low(021h)
	bsf	status, 6	;RP1=1, select bank2
	movwf	(284)^0100h	;volatile
	line	58
;main.c: 58: while(SPIIF==0);
...
;; Defined at:
;;		line 74 in file "H:\MyDownloads\说明书&测试报告\开发包\SC8F577X开发包\SC8F577X_DEMO\SC8F577X_SPI_master_Demo\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l1301:	
# 76 "H:\MyDownloads\说明书&测试报告\开发包\SC8F577X开发包\SC8F577X_DEMO\SC8F577X_SPI_master_Demo\main.c"
nop ;# 
	line	77
# 77 "H:\MyDownloads\说明书&测试报告\开发包\SC8F577X开发包\SC8F577X_DEMO\SC8F577X_SPI_master_Demo\main.c"
clrwdt ;# 
psect	text1
	line	78
...
l1311:	
;main.c: 83: WPUB = 0B00000000;
	clrf	(8)	;volatile
	line	86
	
l1313:	
;main.c: 86: TRISA = 0B00000000;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(133)^080h	;volatile
	line	87
	
l1315:	
;main.c: 87: TRISB = 0B00100100;
	movlw	low(024h)
	movwf	(134)^080h	;volatile
	line	89
;main.c: 89: PORTA = 0B00000000;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(5)	;volatile
	line	90
;main.c: 90: PORTB = 0B00000000;
	clrf	(6)	;volatile
	line	92
...
;; *************** function _DelayXms *****************
;; Defined at:
;;		line 24 in file "H:\MyDownloads\说明书&测试报告\开发包\SC8F577X开发包\SC8F577X_DEMO\SC8F577X_SPI_master_Demo\main.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _PB_Isr *****************
;; Defined at:
;;		line 101 in file "H:\MyDownloads\说明书&测试报告\开发包\SC8F577X开发包\SC8F577X_DEMO\SC8F577X_SPI_master_Demo\main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
