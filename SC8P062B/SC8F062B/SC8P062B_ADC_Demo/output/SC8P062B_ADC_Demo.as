...
;; *************** function _main *****************
;; Defined at:
;;		line 118 in file "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
...
psect	maintext,global,class=CODE,delta=2,split=1,group=0
	file	"C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
	line	118
global __pmaintext
...
l1424:	
;SC8P062B_ADC.c: 120: Init_System();
	fcall	_Init_System
	line	121
;SC8P062B_ADC.c: 121: AD_Init();
	fcall	_AD_Init
	line	122
;SC8P062B_ADC.c: 122: while (1)
	
l554:	
	line	124
# 124 "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
clrwdt ;# 
psect	maintext
	line	127
	
l1426:	
;SC8P062B_ADC.c: 127: TRISB7 = 1;
	bcf	status, 5	;RP0=0, select bank0
	bsf	(47/8),(47)&7	;volatile
	line	128
	
l1428:	
;SC8P062B_ADC.c: 128: ANSEL1 |= 0X80;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(148)^080h+(7/8),(7)&7	;volatile
	line	129
;SC8P062B_ADC.c: 129: test_adc = ADC_Sample(15, 7);
	movlw	low(07h)
...
l1430:	
;SC8P062B_ADC.c: 130: if (0xA5 == test_adc)
		movlw	165
...
l1434:	
;SC8P062B_ADC.c: 134: else
;SC8P062B_ADC.c: 135: {
;SC8P062B_ADC.c: 136: ADCON0 = 0;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(149)^080h	;volatile
	line	137
;SC8P062B_ADC.c: 137: ADCON1 = 0;
	clrf	(150)^080h	;volatile
	line	138
	
l1436:	
;SC8P062B_ADC.c: 138: _delay((unsigned long)((100)*(16000000/4000000.0)));
	opt asmopt_push
opt asmopt_off
	movlw	132
	bcf	status, 5	;RP0=0, select bank0
...
l1438:	
;SC8P062B_ADC.c: 139: }
;SC8P062B_ADC.c: 141: test_adc = ADC_Sample(31, 0);
...
l1440:	
;SC8P062B_ADC.c: 142: if (0xA5 == test_adc)
		movlw	165
	xorwf	((_test_adc)),w	;volatile
	btfss	status,2
	goto	u771
...
l1442:	
;SC8P062B_ADC.c: 143: {
;SC8P062B_ADC.c: 144: volatile unsigned long power_temp;
;SC8P062B_ADC.c: 146: power_temp = (unsigned long)(((4096UL*1.2*1000))/adresult);
	movlw	0x0
	movwf	(___ftdiv@f1)
	movlw	0x96
	movwf	(___ftdiv@f1+1)
...
l1444:	
;SC8P062B_ADC.c: 147: power_ad = (unsigned int)(power_temp);
...
;; Defined at:
;;		line 161 in file "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l1286:	
# 163 "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
nop ;# 
	line	164
# 164 "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
clrwdt ;# 
psect	text5
	line	165
	
l1288:	
;SC8P062B_ADC.c: 165: OPTION_REG = 0;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(1)	;volatile
	line	166
# 166 "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
clrwdt ;# 
psect	text5
	line	167
	
l1290:	
;SC8P062B_ADC.c: 167: OSCCON = 0X70;
	movlw	low(070h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(20)	;volatile
	line	169
...
l1292:	
;SC8P062B_ADC.c: 169: WPUA = 0B00000000;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(136)^080h	;volatile
	line	170
	
l1294:	
;SC8P062B_ADC.c: 170: WPUB = 0B00000000;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(8)	;volatile
	line	172
	
l1296:	
;SC8P062B_ADC.c: 172: TRISA = 0B00000000;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(133)^080h	;volatile
	line	173
	
l1298:	
;SC8P062B_ADC.c: 173: TRISB = 0B00000000;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(5)	;volatile
	line	175
	
l1300:	
;SC8P062B_ADC.c: 175: PORTA = 0X00;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(134)^080h	;volatile
	line	176
	
l1302:	
;SC8P062B_ADC.c: 176: PORTB = 0X00;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(6)	;volatile
	line	180
	
l1304:	
;SC8P062B_ADC.c: 180: PR2 = 249;
	movlw	low(0F9h)
	movwf	(17)	;volatile
	line	181
	
l1306:	
;SC8P062B_ADC.c: 181: TMR2IF = 0;
	bcf	(105/8),(105)&7	;volatile
	line	182
	
l1308:	
;SC8P062B_ADC.c: 182: TMR2IE = 1;
	bsf	(113/8),(113)&7	;volatile
	line	184
	
l1310:	
;SC8P062B_ADC.c: 184: T2CON = 0B00000100;
	movlw	low(04h)
	movwf	(19)	;volatile
	line	185
	
l1312:	
;SC8P062B_ADC.c: 185: INTCON = 0XC0;
	movlw	low(0C0h)
	movwf	(11)	;volatile
	line	186
...
;; *************** function _AD_Init *****************
;; Defined at:
;;		line 216 in file "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l1314:	
;SC8P062B_ADC.c: 249: ADCON0 = 0X41;
	movlw	low(041h)
	bsf	status, 5	;RP0=1, select bank1
...
;; Defined at:
;;		line 46 in file "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
;; Parameters:    Size  Location     Type
...
l1214:	
;SC8P062B_ADC.c: 48: volatile unsigned long adsum = 0;
...
l1216:	
;SC8P062B_ADC.c: 49: volatile unsigned int admin = 0, admax = 0;
	clrf	(ADC_Sample@admin)	;volatile
	clrf	(ADC_Sample@admin+1)	;volatile
	clrf	(ADC_Sample@admax)	;volatile
	clrf	(ADC_Sample@admax+1)	;volatile
	line	50
;SC8P062B_ADC.c: 50: volatile unsigned int ad_temp = 0;
	clrf	(ADC_Sample@ad_temp)	;volatile
	clrf	(ADC_Sample@ad_temp+1)	;volatile
	line	52
	
l1218:	
;SC8P062B_ADC.c: 52: if ((!LDO_EN) && (adldo & 0x04) )
	bsf	status, 5	;RP0=1, select bank1
...
l1222:	
;SC8P062B_ADC.c: 53: {
;SC8P062B_ADC.c: 55: ADCON1 = adldo;
	movf	(ADC_Sample@adldo),w
	movwf	(150)^080h	;volatile
	line	56
;SC8P062B_ADC.c: 56: _delay((unsigned long)((100)*(16000000/4000000.0)));
	opt asmopt_push
opt asmopt_off
	movlw	133
...
l1224:	
;SC8P062B_ADC.c: 58: else
;SC8P062B_ADC.c: 59: ADCON1 = adldo;
	movf	(ADC_Sample@adldo),w
	movwf	(150)^080h	;volatile
	line	61
	
l1226:	
;SC8P062B_ADC.c: 61: if(adch & 0x10)
	bcf	status, 5	;RP0=0, select bank0
...
l1228:	
;SC8P062B_ADC.c: 62: {
;SC8P062B_ADC.c: 63: CHS4 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1206/8)^080h,(1206)&7	;volatile
	line	64
	
l1230:	
;SC8P062B_ADC.c: 64: adch &= 0x0f;
	movlw	low(0Fh)
	bcf	status, 5	;RP0=0, select bank0
...
l1234:	
;SC8P062B_ADC.c: 67: for (i = 0; i < 10; i++)
	clrf	(ADC_Sample@i)
	line	69
	
l1240:	
;SC8P062B_ADC.c: 68: {
;SC8P062B_ADC.c: 69: ADCON0 = (unsigned char)(0X41 | (adch << 2));
...
u505:
	...
	movwf	(149)^080h	;volatile
	line	70
# 70 "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
nop ;# 
	line	71
# 71 "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
nop ;# 
	line	72
# 72 "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
nop ;# 
	line	73
# 73 "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
nop ;# 
psect	text7
	line	74
	
l1242:	
;SC8P062B_ADC.c: 74: GODONE = 1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1193/8)^080h,(1193)&7	;volatile
	line	76
	
l1244:	
;SC8P062B_ADC.c: 76: unsigned char j = 0;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(ADC_Sample@j)
	line	77
;SC8P062B_ADC.c: 77: while (GODONE)
	goto	l538
	
l539:	
	line	79
;SC8P062B_ADC.c: 78: {
;SC8P062B_ADC.c: 79: _delay((unsigned long)((2)*(16000000/4000000.0)));
		opt asmopt_push
	opt asmopt_off
	nop2	;2 cycle nop
	nop2	;2 cycle nop
...
l1250:	
;SC8P062B_ADC.c: 83: }
;SC8P062B_ADC.c: 85: ad_temp = (unsigned int)((ADRESH << 4) + (ADRESL >> 4));
...
l1256:	
;SC8P062B_ADC.c: 88: {
;SC8P062B_ADC.c: 89: admax = ad_temp;
	movf	(ADC_Sample@ad_temp+1),w	;volatile
	movwf	(ADC_Sample@admax+1)	;volatile
	movf	(ADC_Sample@ad_temp),w	;volatile
	movwf	(ADC_Sample@admax)	;volatile
	line	90
;SC8P062B_ADC.c: 90: admin = ad_temp;
	movf	(ADC_Sample@ad_temp+1),w	;volatile
...
l1258:	
;SC8P062B_ADC.c: 92: else if (ad_temp > admax)
	movf	(ADC_Sample@ad_temp+1),w	;volatile
...
l1260:	
;SC8P062B_ADC.c: 93: admax = ad_temp;
	movf	(ADC_Sample@ad_temp+1),w	;volatile
	movwf	(ADC_Sample@admax+1)	;volatile
	movf	(ADC_Sample@ad_temp),w	;volatile
	movwf	(ADC_Sample@admax)	;volatile
...
l1262:	
;SC8P062B_ADC.c: 94: else if (ad_temp < admin)
...
l1264:	
;SC8P062B_ADC.c: 95: admin = ad_temp;
	movf	(ADC_Sample@ad_temp+1),w	;volatile
	movwf	(ADC_Sample@admin+1)	;volatile
	movf	(ADC_Sample@ad_temp),w	;volatile
	movwf	(ADC_Sample@admin)	;volatile
...
l544:	
;SC8P062B_ADC.c: 97: adsum += ad_temp;
	movf	(ADC_Sample@ad_temp),w	;volatile
	movwf	((??_ADC_Sample+0)+0)
	movf	(ADC_Sample@ad_temp+1),w	;volatile
...
u580:
	...
	line	100
;SC8P062B_ADC.c: 100: if (adsum >= admin)
	movf	(ADC_Sample@admin),w	;volatile
	movwf	((??_ADC_Sample+0)+0)
	movf	(ADC_Sample@admin+1),w	;volatile
	movwf	((??_ADC_Sample+0)+0+1)
...
l1272:	
;SC8P062B_ADC.c: 101: adsum -= admin;
	movf	(ADC_Sample@admin),w	;volatile
	movwf	((??_ADC_Sample+0)+0)
	movf	(ADC_Sample@admin+1),w	;volatile
	movwf	((??_ADC_Sample+0)+0+1)
...
l548:	
	line	103
;SC8P062B_ADC.c: 102: else
;SC8P062B_ADC.c: 103: adsum = 0;
	clrf	(ADC_Sample@adsum)	;volatile
	clrf	(ADC_Sample@adsum+1)	;volatile
	clrf	(ADC_Sample@adsum+2)	;volatile
	clrf	(ADC_Sample@adsum+3)	;volatile
...
l1274:	
;SC8P062B_ADC.c: 105: adresult = adsum >> 3;
...
l1278:	
;SC8P062B_ADC.c: 108: admin = 0;
	clrf	(ADC_Sample@admin)	;volatile
	clrf	(ADC_Sample@admin+1)	;volatile
	line	109
	
l1280:	
;SC8P062B_ADC.c: 109: admax = 0;
	clrf	(ADC_Sample@admax)	;volatile
	clrf	(ADC_Sample@admax+1)	;volatile
	line	110
	
l1282:	
;SC8P062B_ADC.c: 110: return 0xA5;
	movlw	low(0A5h)
	line	112
...
;; *************** function _Isr_Timer *****************
;; Defined at:
;;		line 197 in file "C:\mcuproject\scm\SC8P062B\SC8F062B\SC8P062B_ADC_Demo\SC8P062B_ADC.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
