...
;main.c: 900: else
;main.c: 901: {
;main.c: 902: PWMD0L = 59 + (workStep*2);
	clrc
	rlf	(_workStep),w
	addlw	03Bh
	movwf	(23)	;volatile
...
l4662:	
;main.c: 341: {
;main.c: 342: batValue = ((batResult - 1340) /2) + 16;
	movf	(_batResult),w
	addlw	low(0FAC4h)
	movwf	(??_checkBat+0)+0
	movf	(_batResult+1),w
