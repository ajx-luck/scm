...
{ 
	...
	ADCON1 = 0xC2;					//1100 1011 使能ADC 32分频 AN17通道 
	ADCON0 |= 1<<1;		
	while(ADCON0 & 0x02);
	...
	//SC
	ADCON0 = 0xD0;					//1101 0000 右对齐 AN31 1 1111
	ADCON1 = 0xC7;					//1100 1111 使能ADC 32分频 AN31通道 
	ADCON0 |= 1<<1;		
	while(ADCON0 & 0x02);
	...
	//KEY
	ADCON0 = 0xC0;					//1101 0000 右对齐 AN9 1 0000
...
//	AD_KeyValueSum += AD_KeyValueTemp;
	...
	if(AD_CollectCnt == COOLECTCNT)
	{
		...
		AD_KeyValue = AD_KeyValueSum >> SHIFTVALUE;
