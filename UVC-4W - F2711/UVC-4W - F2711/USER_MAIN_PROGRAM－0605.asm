...
;-----------初始化I/O-----------------------;设置IO口的初始状态
		...
		LDIA		B'11101000'		;P0,0为按键,P0,1=SW,P02-OUT,P0,3=AD
		LD  		P0CL,A	  
...
;*****************************************		
M_LOOP:		
        LDIA         .15               ;如果有安键，就查询7.5S
		LD           CNT_b,A		   ;15*0.5=7.5S
DJ_01:
  	    LDIA         100;              ;计时500MS  按第1次
		LD           CNT_a,A
		LDIA         B'00000100'       ;P0,2测循环周期，500MS
		XORR         P0
DJ_02:;单击	
        CLR 		 TCOUNT	
	;	LDIA         B'00000100'       ;P0,2测循环周期，500MS
...
USER_ENTER_SLEEP:
	...
	;	CLRB 		P0,4
		...
		CLRB        P0,7
	;	SETB        P2,2
		LDIA		B'10101010'     ;P0,6;P0,4输出,P0,5 AD
		LD  		P0CH,A	
		
		LDIA		B'11101000'		;P0,0为按键,P0,1=SW OUT,P02-OUT,P0,3=AD
		LD  		P0CL,A	  
		     
		LDIA		B'10010010'    ;P1,6输出，P1,5-不用,P1,4-OUT
		LD  		P1CH,A
		LDIA  		B'10101010'
		LD  		P1CL,A
