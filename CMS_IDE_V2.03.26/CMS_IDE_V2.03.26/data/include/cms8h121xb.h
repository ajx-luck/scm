#ifndef _HTC_H_
#warning Header file cms8h121xb.h included directly. Use #include <cms.h> instead.
#endif

/* header file for the cms microcontroller. Base On Datasheet V0.0.1
    CMS8H1213B
    CMS8H1215
*/

#ifndef __CMS8H121xB_H
#define __CMS8H121xB_H
...
volatile 	unsigned char 	WPUD	@	0x09;
volatile 	unsigned char 	PCLATH	@	0x0A;
volatile 	unsigned char 	INTCON	@	0x0B;
volatile 	unsigned char 	PIR1	@	0x0C;
volatile 	unsigned char 	PIR2	@	0x0D;
volatile 	unsigned char 	PWMCON0	@	0x0E;
volatile 	unsigned char 	PWMCON1	@	0x0F;
volatile 	unsigned char 	PWMTH	@	0x10;
volatile 	unsigned char 	TMR2	@	0x11;
volatile 	unsigned char 	T2CON	@	0x12;
volatile 	unsigned char 	PWMD0L	@	0x13;
volatile 	unsigned char 	PWMD1L	@	0x14;
...
volatile 	unsigned char 	PWM0TL	@	0x1C;
volatile 	unsigned char 	PWM1TL	@	0x1D;
...
volatile 	unsigned char 	ANSEL1	@	0x114;
volatile 	unsigned char 	LVDCON	@	0x115;
volatile 	unsigned char 	PAPI	@	0x116;
volatile 	unsigned char 	PBPI	@	0x117;
volatile 	unsigned char 	COMENA	@	0x118;
volatile 	unsigned char 	COMENB	@	0x119;
volatile 	unsigned char 	SEGENA	@	0x11A;
volatile 	unsigned char 	SEGENB	@	0x11B;
volatile 	unsigned char 	IOSR	@	0x11C;
volatile 	unsigned char 	BUZCON0	@	0x11D;
volatile 	unsigned char 	BUZCON1	@	0x11E;
volatile 	unsigned char 	LVDCON1	@	0x11F;
...
volatile 	 bit 	 PWMIF	 @ ((unsigned)&PIR1*8)+6;
...
volatile 	 bit 	 PWM1DIR	 @ ((unsigned)&PWMCON1*8)+1;
volatile 	 bit 	 PWM0DIR	 @ ((unsigned)&PWMCON1*8)+0;

/* Definitions for PWMTH  register */
volatile 	 bit 	 PWM1T9	 @ ((unsigned)&PWMTH*8)+5;
volatile 	 bit 	 PWM1T8	 @ ((unsigned)&PWMTH*8)+4;
volatile 	 bit 	 PWM0T9	 @ ((unsigned)&PWMTH*8)+1;
volatile 	 bit 	 PWM0T8	 @ ((unsigned)&PWMTH*8)+0;
...
volatile 	 bit 	 ENSAR	 @ ((unsigned)&AFECON2*8)+2;
volatile 	 bit 	 ENCHOPB	 @ ((unsigned)&AFECON2*8)+1;
...
volatile 	 bit 	 PGA_SEL3	 @ ((unsigned)&AFECON3*8)+3;
volatile 	 bit 	 RD01_SEL	 @ ((unsigned)&AFECON3*8)+1;
...
volatile 	 bit 	 PWMIE	 @ ((unsigned)&PIE1*8)+6;
...
volatile 	 bit 	 AIN2	 @ ((unsigned)&ANSEL1*8)+1;
volatile 	 bit 	 AIP2	 @ ((unsigned)&ANSEL1*8)+0;
...
/* Definitions for IOSR  register */
volatile 	 bit 	 IOSRBH1	 @ ((unsigned)&IOSR*8)+7;
volatile 	 bit 	 IOSRBH0	 @ ((unsigned)&IOSR*8)+6;
volatile 	 bit 	 IOSRBL1	 @ ((unsigned)&IOSR*8)+5;
volatile 	 bit 	 IOSRBL0	 @ ((unsigned)&IOSR*8)+4;
volatile 	 bit 	 IOSRAH1	 @ ((unsigned)&IOSR*8)+3;
volatile 	 bit 	 IOSRAH0	 @ ((unsigned)&IOSR*8)+2;
volatile 	 bit 	 IOSRAL1	 @ ((unsigned)&IOSR*8)+1;
volatile 	 bit 	 IOSRAL0	 @ ((unsigned)&IOSR*8)+0;
...
/* Definitions for LVDCON1  register */
volatile 	 bit 	 DAC_HVVBAT1	 @ ((unsigned)&LVDCON1*8)+1;
volatile 	 bit 	 DAC_HVVBAT0	 @ ((unsigned)&LVDCON1*8)+0;
