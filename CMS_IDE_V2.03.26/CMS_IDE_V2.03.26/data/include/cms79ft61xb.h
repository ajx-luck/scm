...
#ifndef _HTC_H_
#warning Header file cms79ft61xb.h included directly. Use #include <cms.h> instead.
#endif
...
#ifndef __CMS79FT61XB_H_
#define __CMS79FT61XB_H_
...
volatile 	unsigned char 	IOCB	@	0x0D;
...
volatile 	unsigned char 	WDTCON	@	0x89;
...
volatile 	unsigned char 	TABLE_DATAH	@	0x94;
...
volatile 	unsigned char 	TABLE_SPH	@	0x9A;
volatile 	unsigned char 	TABLE_SPL	@	0x9B;
...
volatile 	unsigned char 	PIR1	@	0x105;
volatile 	unsigned char 	PIE1	@	0x106;
...
volatile 	unsigned char 	PAHEN	@	0x113;
volatile 	unsigned char 	PALEN	@	0x114;
volatile 	unsigned char 	PBHEN	@	0x115;
volatile 	unsigned char 	PBLEN	@	0x116;
...
volatile 	unsigned char 	SEGCUR	@	0x11C;
...
volatile 	 bit 	 TKM1IF	 @ ((unsigned)&PIR2*8)+7;
volatile 	 bit 	 TKM0IF	 @ ((unsigned)&PIR2*8)+6;
volatile 	 bit 	 EEIF	 @ ((unsigned)&PIR2*8)+4;
volatile 	 bit 	 RACIF	 @ ((unsigned)&PIR2*8)+1;

/* Definitions for PIE2  register */
volatile 	 bit 	 TKM1IE	 @ ((unsigned)&PIE2*8)+7;
volatile 	 bit 	 TKM0IE	 @ ((unsigned)&PIE2*8)+6;
