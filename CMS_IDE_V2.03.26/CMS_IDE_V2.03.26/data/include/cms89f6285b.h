...
#ifndef	_HTC_H_
#warning Header file cms89f6285B.h included directly. Use #include <cms.h> instead.
#endif
...
#ifndef	__CMS89F6285B_H
#define	__CMS89F6285B_H
...
volatile	   bit	BRGHEN	@ ((unsigned)&TXSTA*8)+2;
...
volatile       bit	BRG16EN	@ ((unsigned)&BAUDCTL*8)+3;
