...
#ifndef	_HTC_H_
#warning Header file cms89f3001.h included directly. Use #include <htc.h> instead.
#endif
...
#ifndef	__CMS89F3001_H
#define	__CMS89F3001_H
...
volatile		unsigned char	EECON1		@ 0x08C;
volatile		unsigned char	EECON2		@ 0x08D;
volatile		unsigned char	EEDATA		@ 0x08E;
volatile		unsigned char	EEDAT		@ 0x08E;
volatile		unsigned char	EEDATH		@ 0x08F;
volatile		unsigned char	EEADR		@ 0x090;
...
volatile		bit	EEADR11	@ ((unsigned)&EEADRH*8)+3;
volatile		bit	EEADR10	@ ((unsigned)&EEADRH*8)+2;
volatile		bit	EEADR9	@ ((unsigned)&EEADRH*8)+1;
volatile		bit	EEADR8 	@ ((unsigned)&EEADRH*8)+0;
