#ifndef _HTC_H_
#warning Header file cms89f5233b.h included directly. Use #include <cms.h> instead.
#endif
...
#ifndef __CMS89F5233B_H
#define __CMS89F5233B_H
...
volatile 	unsigned char 	LDOOUTEN	@	0x106;
...
volatile 	unsigned char 	PPGCON	@	0x192;
volatile 	unsigned char 	PPGDELY	@	0x195;
...
/* Definitions for LDOOUTEN  register */
volatile 	 bit 	 DACVREF	 @ ((unsigned)&LDOOUTEN*8)+7;
...
volatile 	 bit 	 PPGON	 @ ((unsigned)&PPGCON*8)+0;

/* Definitions for PPGDELY  register */
volatile 	 bit 	 PPGDLY3	 @ ((unsigned)&PPGDELY*8)+6;
volatile 	 bit 	 PPGDLY2	 @ ((unsigned)&PPGDELY*8)+5;
volatile 	 bit 	 PPGDLY1	 @ ((unsigned)&PPGDELY*8)+4;
volatile 	 bit 	 PPGDLY0	 @ ((unsigned)&PPGDELY*8)+3;
