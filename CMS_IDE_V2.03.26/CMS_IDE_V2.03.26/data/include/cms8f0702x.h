#ifndef _HTC_H_
#warning Header file cms8f0702x.h included directly. Use #include <cms.h> instead.
#endif
...
#ifndef __CMS8F0702X_H
#define __CMS8F0702X_H
...
volatile 	unsigned char 	SPBRG1		@	0x98;
...
volatile 	unsigned char 	INTCON2		@	0x114;
...
volatile 	unsigned char 	TXREG1		@	0x11D;
volatile 	unsigned char 	RCREG1		@	0x11E;
volatile 	unsigned char 	TXSTA1		@	0x11F;
...
volatile 	 bit 	 INTSTAT1	 @ ((unsigned)&INTCON2*8)+7;
volatile 	 bit 	 INTSTAT0	 @ ((unsigned)&INTCON2*8)+6;
volatile 	 bit 	 HPRIIF	 @ ((unsigned)&INTCON2*8)+5;
volatile 	 bit 	 INTPS4	 @ ((unsigned)&INTCON2*8)+4;
volatile 	 bit 	 INTPS3	 @ ((unsigned)&INTCON2*8)+3;
volatile 	 bit 	 INTPS2	 @ ((unsigned)&INTCON2*8)+2;
volatile 	 bit 	 INTPS1	 @ ((unsigned)&INTCON2*8)+1;
volatile 	 bit 	 INTPS0	 @ ((unsigned)&INTCON2*8)+0;
