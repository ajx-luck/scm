...
#ifndef _HTC_H_
#warning Header file cms89f5526b.h included directly. Use #include <cms.h> instead.
#endif

 /* header file for the cms microcontroller. Base on datasheet V1.4
    CMS89F5526B
 */

#ifndef __CMS89F5526B_H__
#define __CMS89F5526B_H__
...
volatile     bit     KCHS4   @ ((unsigned)&KEYCON2*8)+1;
