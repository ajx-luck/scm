...
#ifndef	_HTC_H_
#warning Header file cms89f116.h included directly. Use #include <htc.h> instead.
#endif
...
#ifndef	__CMS89F616_H
#define	__CMS89F616_H
...
volatile	unsigned char	EEDAT			@0x025;//
volatile	unsigned char	EEDATH			@0x026;//
volatile	unsigned char	EEADR			@0x027;//
volatile	unsigned char	EEADDR			@0x027;//
volatile	unsigned char	LCDCON			@0x028;//
volatile	unsigned char	IOCA			@0x029;
volatile	unsigned char	EECON1			@0x02A;//
volatile	unsigned char	EECON2			@0x02B;

volatile	unsigned char	KEY_C1			@0x02C;
volatile	unsigned char	KEY_C			@0x02D;
volatile	unsigned char	KEY_DATAL		@0x02E;
volatile	unsigned char	KEY_DATAH		@0x02F;
...
/*Definitions for KEY_C1 register*/
volatile	bit	KEY_CAP			@ ((unsigned)&KEY_C1*8)+1;
volatile	bit	KEY_TMR_FLOW	@ ((unsigned)&KEY_C1*8)+2;
volatile	bit	KEY_INT			@ ((unsigned)&KEY_C1*8)+7;

/*Definitions for KEY_C register*/
volatile	bit	KEY_EN			@ ((unsigned)&KEY_C*8)+7;
