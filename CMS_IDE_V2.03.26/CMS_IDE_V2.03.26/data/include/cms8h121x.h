#ifndef _HTC_H_
#warning Header file cms8h121x.h included directly. Use #include <cms.h> instead.
#endif
...
#ifndef __CMS8H121X_H
#define __CMS8H121X_H
...
volatile 	 bit 	 CH_SEL2	 @ ((unsigned)&AFECON3*8)+7;
volatile 	 bit 	 CH_SEL1	 @ ((unsigned)&AFECON3*8)+6;
volatile 	 bit 	 CH_SEL0	 @ ((unsigned)&AFECON3*8)+5;
