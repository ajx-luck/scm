...
//按键按下消抖次数
#define		C_KEY_SHAKE		3//3~7

//按键放开消抖次数
#define		C_OFF_SHAKE		3//3~7

//待检测按键总数,常量
#define 	C_KEY_TOTAL		8//触摸按键数,范围1~12
...
//噪声阈值
#define		VOL_VALUE		20//无干扰下的最大触摸波动值*2，20~127

//迟滞值
#define		SLU_VALUE		20//手指按下和放开切换的消抖值,此值需小于等于VOL_VALUE/2,范围1~127

//触摸基准值更新消抖次数
#define		CM_BASE			6//消抖时间约为调用周期4ms（主程序时间例如4ms）*按键个数*CM_BASE,范围5~255
...
unsigned int  KeySum[Real_TOTAL];
...
const unsigned char WaterMode = WATER_MODE;
