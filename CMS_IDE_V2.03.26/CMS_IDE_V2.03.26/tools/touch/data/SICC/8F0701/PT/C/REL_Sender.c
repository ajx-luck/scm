...
void REL_SenderLoop()
{
	...
	do
	{
		packStrcut.rawData = g_FactorRawDat[curIdx];				
		packStrcut.thresholdA = g_DispKeyDown[curIdx];
		/*
		#ifdef RS_VALUE
			packStrcut.thresholdB = g_DispKeyDown[curIdx];
		#endif				
		*/
		packStrcut.noiseData = g_NoiseDat[curIdx];
