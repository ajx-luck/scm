...
#if (SEND_NUM % PACK_SEND_COUNT_ONCE)
	#define PACK_IDX_MAX 			(SEND_NUM / PACK_SEND_COUNT_ONCE)
	#define PACK_SEND_COUNT_FINAL	(SEND_NUM % PACK_SEND_COUNT_ONCE)
#else
	#define PACK_IDX_MAX 			((SEND_NUM-1) / PACK_SEND_COUNT_ONCE)
