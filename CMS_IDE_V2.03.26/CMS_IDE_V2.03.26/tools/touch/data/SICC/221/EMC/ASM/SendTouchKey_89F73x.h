...
#ifndef	_SENDTOUCHKEY_89F73X_H_
#define	_SENDTOUCHKEY_89F73X_H_
...
;通讯管脚定义
#if (CMS_DEBUG_MODE == 1)
IIC_SCL			EQU			PORTD,0			;IIC通讯的数据时钟口及方向
IIC_SDA			EQU			PORTD,1
IIC_SCL_IO		EQU			TRISD,0
IIC_SDA_IO		EQU			TRISD,1
#endif
...
;************************************************************************** 
;发送数据类型选择
	#define			SEND_ID			8		;EMC库发送模式，编号8
	#define			DATA_SIZE		8		;发送数据字节
