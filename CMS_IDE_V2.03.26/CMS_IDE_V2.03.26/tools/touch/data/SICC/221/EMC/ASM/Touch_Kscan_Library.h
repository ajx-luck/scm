...
#define		C_KCOUNT		4		;按键个数,最多16个按键
...
;触摸基准值更新消抖次数
#define		CM_BASE			10		;消抖时间约为调用周期4ms（主程序时间例如4ms）*按键个数*CM_BASE
...
;----------------------------------------------------------
;灵敏度阈值2,设定值不可低于20,不能大于255
C_KEY1_LMD_Pro		DEF		.30		;KEY1灵敏度1
C_KEY2_LMD_Pro		DEF		.30		;KEY2灵敏度1
C_KEY3_LMD_Pro		DEF		.30		;KEY3灵敏度1
C_KEY4_LMD_Pro		DEF		.30		;KEY4灵敏度1
C_KEY5_LMD_Pro		DEF		.30		;KEY5灵敏度1
C_KEY6_LMD_Pro		DEF		.30		;KEY6灵敏度1
C_KEY7_LMD_Pro		DEF		.30		;KEY7灵敏度1
C_KEY8_LMD_Pro		DEF		.30		;KEY8灵敏度1
C_KEY9_LMD_Pro		DEF		.30		;KEY9灵敏度1
C_KEY10_LMD_Pro		DEF		.30		;KEY10灵敏度1
C_KEY11_LMD_Pro		DEF		.30		;KEY11灵敏度1
C_KEY12_LMD_Pro		DEF		.30		;KEY12灵敏度1
C_KEY13_LMD_Pro		DEF		.30		;KEY13灵敏度1
C_KEY14_LMD_Pro		DEF		.30		;KEY14灵敏度1
C_KEY15_LMD_Pro		DEF		.30		;KEY15灵敏度1
C_KEY16_LMD_Pro		DEF		.30		;KEY16灵敏度1
;----------------------------------------------------------
;----------------------------------------------------------
;以下数据通常情况下不用修改
;----------------------------------------------------------
