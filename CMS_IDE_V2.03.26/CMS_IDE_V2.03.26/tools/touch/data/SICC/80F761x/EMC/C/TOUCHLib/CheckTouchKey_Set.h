...
//只选前C_KEY_TOTAL个触摸通道
#define C_KEY1_CH		C_KCHS0
#define C_KEY2_CH		C_KCHS1
#define C_KEY3_CH		C_KCHS2
#define C_KEY4_CH		C_KCHS3
...
//迟滞值
#define		SLU_VALUE			15			//手指按下和放开切换的消抖值,此值建议小于等于VOL_VALUE/2,范围1~127
