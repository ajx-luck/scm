...
; ----------------------------------------------------------------------------
; CMS79FTXXX系列MCU触摸传数据程序
; 文 件 名：SendTouchKey_79FT61xB.asm
; 版    本：V0.5
; 修改日期：2020/12/09
; ----------------------------------------------------------------------------
; 使用说明：
; 1.在主函数中 #include "SendTouchKey_79FT61xB.h"以及 #include "SendTouchKey_79FT61xB.asm"
; 2.根据项目实际情况配置好触摸库参数
