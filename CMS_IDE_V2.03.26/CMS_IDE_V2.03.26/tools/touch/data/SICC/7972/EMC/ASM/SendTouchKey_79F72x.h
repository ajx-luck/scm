...
#ifndef	_SENDTOUCHKEY_79F72X_H_
#define	_SENDTOUCHKEY_79F72X_H_
...
;通讯管脚定义
#if (CMS_DEBUG_MODE == 1)
IIC_SCL			EQU			PORTC,1			;IIC通讯的数据时钟口及方向
IIC_SDA			EQU			PORTC,0
IIC_SCL_IO		EQU			TRISC,1
IIC_SDA_IO		EQU			TRISC,0
#endif
