...
//按键有效时相应位为1,无效时为0
extern volatile unsigned char _CMS_KeyFlag;
//-------------------------------------------------------
...
//触摸基准值更新消抖次数
#define		CM_BASE			10//消抖时间约为(主程序调用时间4ms*2 + 按键个数*1.5) * CM_BASE,范围6~127

//同时最大允许有效按键数,超过该值将认为是干扰
#define		C_VALID_KEY		2//范围1~8
...
unsigned int _CMS_DispKeyDownPro[C_KEY_TOTAL];
