...
extern void __CMS_CheckTouchKey_SL(void);
extern void __CMS_GetTouchKeyValue(void);//此函数放在中断，建议中断扫描时间125us
extern volatile bit _CMS_b_kerr;				//复位按键标志
extern volatile unsigned char _CMS_position;//位置寄存器，圆盘范围0~127，横向滑条0~95
...
const unsigned char _CMS_Table_CAP_Set[] = {
...
//0：横向滑条
//1：圆盘滑条
#define 	CMS_HT_MODE		1//0或1

//待检测按键总数,常量
#define 	C_KEY_TOTAL		10//1~14,按键最多支持14通道
...
//滑条偏移量
#define		KEYOFFSET		10//范围1~100,需小于设定的灵敏度阈值

//休眠模式使能按键
#define		KEY_SLEN0		0x7e//按键组1,bit0~bit7分别对应芯片管脚上TK0~TK7按键，相应位置1使能
#define		KEY_SLEN1		0xf0//按键组2,bit0~bit7分别对应芯片管脚上TK8~TK15按键，相应位置1使能
...
unsigned char _CMS_CurStep[KEY_REALNUM];

const unsigned char _CMS_HTMode = CMS_HT_MODE;
...
const unsigned char _CMS_KeyOffSet = KEYOFFSET;
