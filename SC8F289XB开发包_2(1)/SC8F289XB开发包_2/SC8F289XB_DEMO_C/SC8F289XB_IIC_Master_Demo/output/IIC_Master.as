...
psect	maintext,global,class=CODE,delta=2,split=1,group=0
	file	"C:\Edward_work_FILE\work_file\开发文件\按芯片分类资料\SC\SC8F67XX\SC8F67XX_IIC_Master_Demo\main.c"
	line	102
global __pmaintext
...
l1535:	
# 133 "C:\Edward_work_FILE\work_file\开发文件\按芯片分类资料\SC\SC8F67XX\SC8F67XX_IIC_Master_Demo\main.c"
nop ;# 
	line	134
# 134 "C:\Edward_work_FILE\work_file\开发文件\按芯片分类资料\SC\SC8F67XX\SC8F67XX_IIC_Master_Demo\main.c"
clrwdt ;# 
psect	text3
	line	135
...
l1545:	
;main.c: 139: WPUA = 0B00000000;
	bcf	status, 6	;RP1=0, select bank0
	clrf	(7)	;volatile
	line	140
;main.c: 140: WPUB = 0B00001000;
	movlw	low(08h)
	movwf	(8)	;volatile
	line	143
;main.c: 143: TRISA = 0B00000011;
	movlw	low(03h)
	bsf	status, 5	;RP0=1, select bank1
	movwf	(133)^080h	;volatile
	line	144
;main.c: 144: TRISB = 0B00001000;
	movlw	low(08h)
	movwf	(134)^080h	;volatile
	line	146
;main.c: 146: PORTA = 0B00000011;
	movlw	low(03h)
